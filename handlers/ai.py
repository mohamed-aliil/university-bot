...
async def _ai_user_question(message: Message, state: FSMContext) -> None:
    ...
    system_prompt = (
        ...
        "- استخدم قاعدة المعرفة والمواد والمقالات للإجابة حصرياً من النص المقدم.\n"
        "- عندما يسألك عن محتويات مادة معينة، ابحث في المقالات عن تلك المادة واذكر المحتويات كما هي من المقال حرفياً.\n"
        "- عندما تذكر توزيع الدرجات، انقل الأرقام كما هي من المقال دون تحويل (مثلاً 20 درجة وليس 20%).\n"
        "- لا تخترع أو تلخص محتويات من خارج النص المقدم — إذا ما لقيت المعلومة في المقالات أو المواد قل ذلك.\n"
        "- عندما تستخدم معلومة من المقالات أو قاعدة المعرفة: انقل الحقائق والأرقام كما هي بدون تغيير أو تحريف. أما أسلوب الرد (نصائح، أدعية، توجيه) فطبيعي بكيفك.\n"
